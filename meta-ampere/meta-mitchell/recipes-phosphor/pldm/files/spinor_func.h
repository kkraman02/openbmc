...
extern int spinor_lfs_file_read(char *file, char *buff, uint32_t offset, uint32_t size);
extern int spinor_lfs_file_write(char *file, char *buff, uint32_t offset, uint32_t size);
