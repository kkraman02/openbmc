...
do_bp_cpld_firmware_report() {
	...
	if [[ $BP_ID == 1 ]]; then
		...
		ampere_cpldupdate_i2c -b 101 -s 0x40 -v
		ampere_cpldupdate_i2c -b 101 -s 0x40 -i
	elif [[ $BP_ID == 2 ]]; then
		echo "Front Backplane 2 CPLD"
		ampere_cpldupdate_i2c -b 102 -s 0x40 -v
		ampere_cpldupdate_i2c -b 102 -s 0x40 -i
	elif [[ $BP_ID == 3 ]]; then
		echo "Front Backplane 3 CPLD"
		ampere_cpldupdate_i2c -b 100 -s 0x40 -v
		ampere_cpldupdate_i2c -b 100 -s 0x40 -i
	elif [[ $BP_ID == 4 ]]; then
		echo "Rear Backplane 1 CPLD"
		ampere_cpldupdate_i2c -b 103 -s 0x40 -v
		ampere_cpldupdate_i2c -b 103 -s 0x40 -i
	elif [[ $BP_ID == 5 ]]; then
		echo "Rear Backplane 2 CPLD"
		ampere_cpldupdate_i2c -b 104 -s 0x40 -v
		ampere_cpldupdate_i2c -b 104 -s 0x40 -i
	fi
}
