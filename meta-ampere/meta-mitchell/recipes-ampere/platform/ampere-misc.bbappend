...
PACKAGECONFIG += " mctp-ctrl nmi-manager crash-capture-manager"
PACKAGECONFIG[mctp-ctrl] = "-Dmctp-ctrl=enabled -Dmctp-delay-before-add-terminus=0 \
                            -Dmctp-delay-before-add-second-terminus=2000 \
...
do_install:append () {
    ...
    install -m 0755 ${WORKDIR}/ampere_mctp_ctrl.sh ${D}/${sbindir}/
